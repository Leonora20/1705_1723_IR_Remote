...
public class TV_StartStopReceiver  extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (type) {
            ...
            Intent intent_rr = new Intent(context, TV_RemoteReceiver.class);
            ...
            if (start==1) {
                TV_RemoteReceiver.stopTV(context);
                status = 0;
                editor = prefs.edit();
