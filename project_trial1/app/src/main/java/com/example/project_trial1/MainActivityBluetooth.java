...
import com.example.project_trial1.bluetooth.BluetoothController;
import com.example.project_trial1.view.DeviceRecyclerViewAdapter;
import com.example.project_trial1.view.ListInteractionListener;
import com.example.project_trial1.view.RecyclerViewProgressEmptySupport;
import com.google.android.material.floatingactionbutton.FloatingActionButton;
import com.google.android.material.snackbar.Snackbar;

public class MainActivityBluetooth extends AppCompatActivity implements ListInteractionListener<BluetoothDevice> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!hasBluetooth) {
            AlertDialog dialog = new AlertDialog.Builder(MainActivityBluetooth.this).create();
