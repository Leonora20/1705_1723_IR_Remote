...
public class IRController extends Thread
{
    ...
    public void run()
    {
        Log.d("InterruptedException","Worker Starts!");
        while(true)
        {
            ...
            synchronized(_messageLock)
            {
                if(_messageQueue.size() > 0)
                {
                    ...
                    if(message == null)
                    {
                        Log.d("InterruptedException", "Closing Worker!");
                        break;
                    }
                }
                else
                {
                    ...
                    {
                        Log.d("InterruptedException","Interupted");
                    }
                }
            }
        ...
        Log.d("InterruptedException","Worker Stops!");
    }
