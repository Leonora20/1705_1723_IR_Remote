...
public class Speaker_StartStopReceiver  extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (type) {
            ...
            Intent intent_rr = new Intent(context, Speaker_RemoteReceiver.class);
            ...
            if (start==1) {
                Speaker_RemoteReceiver.stopSpeaker(context);
                status = 0;
                editor = prefs.edit();
